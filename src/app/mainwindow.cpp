...
void MainWindow::setupTrayIcon()
{
    ...
    QAction* fullScreenCaptureAction = m_trayMenu->addAction(QStringLiteral("Full Screen Capture"));
    connect(fullScreenCaptureAction, &QAction::triggered, this, &MainWindow::startFullScreenCapture);
